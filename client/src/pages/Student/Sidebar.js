...
import { FaMoneyBillWave, FaCog, FaSignOutAlt,FaBookOpen,FaUserAlt, FaChalkboardTeacher, FaTachometerAlt} from "react-icons/fa";
          ...
          <ul className="space-y-8">
            <li className="flex items-center hover:text-gray-300 transition duration-200">
              <Link to="/dashboard" className="flex items-center no-underline">
                <FaTachometerAlt className="mr-3 text-white text-lg" />
            ...
            <li className="flex items-center hover:text-gray-300 transition duration-200">
              <Link to="/students" className="flex items-center no-underline">
                <FaChalkboardTeacher className="mr-3 text-white text-lg" />
                <span className="text-sm text-white font-medium">Teachers</span>
              </Link>
            </li>
            <li className="flex items-center hover:text-gray-300 transition duration-200">
              <Link to="/gigs" className="flex items-center no-underline">
                <FaBookOpen className="mr-3 text-white text-lg" />
                <span className="text-sm text-white font-medium">My Course</span>
              </Link>
            </li>
            <li className="flex items-center hover:text-gray-300 transition duration-200">
              <Link to="/payment" className="flex items-center no-underline">
                <FaMoneyBillWave className="mr-3 text-white text-lg" />
                <span className="text-sm text-white font-medium">Fee Payment</span>
              </Link>
            </li>
          </ul>
        </nav>
